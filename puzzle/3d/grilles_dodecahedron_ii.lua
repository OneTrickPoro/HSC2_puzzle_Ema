puzzles:add{
  id = 'grilles_dodecahedron_ii',
  name = 'Grilles Dodecahedron II',
  version = '1.0.0',
  ndim = 3,
  colors = "dodecahedron",
  build = function (self)
